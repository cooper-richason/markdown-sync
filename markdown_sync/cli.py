...
# %% auto 0
__all__ = ['console', 'validate_path', 'find_sync_pair_for_cwd', 'list_configured_pairs', 'add', 'clear_config', 'remove',
           'list_pairs', 'sync', 'main']
...
from .main import sync_obsidian_to_quarto  # Assuming you put the sync code in a separate module
...
def clear_config():
    ...
    config = {}
    save_config(config)
    console.print("✅ Sync pairs cleared!")
